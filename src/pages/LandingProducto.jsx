      ...
      {!cargando && producto && (
        <>
            ...
            <div className="relative mx-auto max-w-6xl">
              {producto.imagen ? (
                <img
                  src={producto.imagen}
                  alt={producto.nombre}
                  className="mx-auto h-[320px] w-full object-contain object-center sm:h-[420px] md:h-[480px]"
                />
              ) : (
                <div className="flex h-64 items-center justify-center text-8xl">
                  {producto.emoji}
                </div>
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 right-0 px-4 pb-8 pt-16 sm:px-6">
              <div className="mx-auto max-w-5xl">
                ...
                <p className="mt-3 text-2xl font-bold text-orange-400 sm:text-3xl">
          ...
          <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
            ...
            <div className="mb-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-8 py-4 text-lg font-bold text-white shadow-lg shadow-green-500/30 transition hover:scale-[1.02] hover:bg-[#20bd5a] sm:w-auto"
              >
                <svg
              ...
              <Link
                ...
                className="inline-flex w-full items-center justify-center rounded-full border-2 border-[#F97316] px-8 py-4 text-lg font-semibold text-[#F97316] transition hover:bg-orange-50 sm:w-auto"
              >
                Ver en la tienda
              </Link>
            </div>
            ...
            {/* CTA final */}
            <section className="rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 p-8 text-center text-white shadow-lg">
              <h2 className="text-2xl font-bold">¿Listo para tu pedido?</h2>
              <p className="mt-2 text-orange-100">
                Escríbenos por WhatsApp y te ayudamos a completar tu compra.
              </p>
              <a
                href={urlPedido}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-3 text-base font-bold text-[#F97316] transition hover:bg-orange-50"
              >
          ...
          <footer className="border-t border-gray-100 py-6 text-center text-sm text-gray-500">
            <Link to="/" className="font-medium text-[#F97316] hover:underline">
              {MARCA.nombre}
            </Link>
